...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#050508]">
      ...
      {/* Main Content */}
      <div className="relative z-10 container-neon">
        <div className="min-h-screen pt-32 pb-20 flex flex-col justify-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-3 px-4 py-2 rounded-md border border-primary/30 bg-primary/5 mb-8"
            >
            ...
            >
              ...
              <span className="text-gradient-cyber">Precision</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-xl text-gray-400 mb-10 max-w-xl font-light"
            >
              Advanced driving programs designed for the next generation of skilled drivers. 
              Expert instruction in Ipaja, Lagos.
            </motion.p>
            ...
            >
              <Link 
                href="/contact" 
                className="btn-neon btn-neon-fill text-base px-8 py-4"
              >
                Start Your Journey
              </Link>
              <Link 
                href="/services" 
                className="btn-neon btn-neon-secondary text-base px-8 py-4"
              >
                Explore Programs
              </Link>
            </motion.div>
            ...
            >
              {[
                ...
                <div key={stat.label} className="text-center">
                  <div className="text-display-md text-gradient-cyber">{stat.value}</div>
                  <div className="font-mono text-xs text-gray-500 mt-1 tracking-widest">{stat.label}</div>
                </div>
              ))}
            </motion.div>
          </motion.div>
